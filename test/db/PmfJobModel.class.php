 ...
 * @package entity
 */
class PmfJobModel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='PmfJobModel';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='pmf_job';
	const SQL_INSERT='INSERT INTO `pmf_job` (`id`,`jobid`,`procid`,`resultid`,`starttime`,`endtime`,`userid`,`extrowid`,`bomstatus`,`procstatus`,`reqorderid`) VALUES (?,?,?,?,?,?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `pmf_job` (`jobid`,`procid`,`resultid`,`starttime`,`endtime`,`userid`,`extrowid`,`bomstatus`,`procstatus`,`reqorderid`) VALUES (?,?,?,?,?,?,?,?,?,?)';
	const SQL_UPDATE='UPDATE `pmf_job` SET `id`=?,`jobid`=?,`procid`=?,`resultid`=?,`starttime`=?,`endtime`=?,`userid`=?,`extrowid`=?,`bomstatus`=?,`procstatus`=?,`reqorderid`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `pmf_job` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `pmf_job` WHERE `id`=?';
	const FIELD_ID=-1047017502;
	const FIELD_JOBID=-1644549775;
	const FIELD_PROCID=733491768;
	const FIELD_RESULTID=1180207999;
	const FIELD_STARTTIME=1917910408;
	const FIELD_ENDTIME=-33366079;
	const FIELD_USERID=877277549;
	const FIELD_EXTROWID=-292838277;
	const FIELD_BOMSTATUS=248964363;
	const FIELD_PROCSTATUS=1703157391;
	const FIELD_REQORDERID=244708946;
	...
	private static $FIELD_NAMES=array(
		...
		self::FIELD_PROCSTATUS=>'procstatus',
	...
	private static $PROPERTY_TYPES=array(
		...
		self::FIELD_JOBID=>Db2PhpEntity::PHP_TYPE_STRING,
		...
		self::FIELD_PROCSTATUS=>Db2PhpEntity::PHP_TYPE_INT,
		self::FIELD_REQORDERID=>Db2PhpEntity::PHP_TYPE_INT);
	private static $FIELD_TYPES=array(
		self::FIELD_ID=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
		self::FIELD_JOBID=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,25,0,false),
		...
		self::FIELD_PROCSTATUS=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
	...
	/**
	 * set value for procstatus 
	 *
	 * type:INT UNSIGNED,size:10,default:0,index
	 *
	 * @param mixed $procstatus
	 * @return PmfJobModel
	 */
	public function &setProcstatus($procstatus) {
		$this->notifyChanged(self::FIELD_PROCSTATUS,$this->procstatus,$procstatus);
		$this->procstatus=$procstatus;
		return $this;
	}

	/**
	 * get value for procstatus 
	 *
	 * type:INT UNSIGNED,size:10,default:0,index
	 *
	 * @return mixed
	...
	public function toArray() {
		return array(
			...
			self::FIELD_PROCSTATUS=>$this->getProcstatus(),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of PmfJobModel instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param PmfJobModel $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return PmfJobModel[]
	 */
	public static function findByExample(PDO $db,PmfJobModel $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of PmfJobModel instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of PmfJobModel instances
	 *
	...
	/**
	 * returns the result as an array of PmfJobModel instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return PmfJobModel[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of PmfJobModel instances.
	 *
	...
	public function assignByHash($result) {
		...
		$this->setProcstatus($result['procstatus']);
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(10,$this->getProcstatus());
		$stmt->bindValue(11,$this->getReqorderid());
	}
	...
	public function insertIntoDatabase(PDO $db) {
		if (null===$this->getId()) {
			...
			$stmt->bindValue(9,$this->getProcstatus());
	...
	/**
	 * Fetch PmfInpinvModel's which this PmfJobModel references.
	 * `pmf_job`.`id` -> `pmf_inpinv`.`jobid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function fetchPmfInpinvModelCollection(PDO $db, $sort=null) {
		$filter=array(PmfInpinvModel::FIELD_JOBID=>$this->getId());
		return PmfInpinvModel::findByFilter($db, $filter, true, $sort);
	}

	/**
	 * Fetch PmfInvModel's which this PmfJobModel references.
	 * `pmf_job`.`id` -> `pmf_inv`.`jobid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return PmfInvModel[]
	...
	public function fetchPmfInvModelCollection(PDO $db, $sort=null) {
		$filter=array(PmfInvModel::FIELD_JOBID=>$this->getId());
		return PmfInvModel::findByFilter($db, $filter, true, $sort);
	}

	/**
	 * Fetch PmfInvhisModel's which this PmfJobModel references.
	 * `pmf_job`.`id` -> `pmf_invhis`.`jobid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function fetchPmfInvhisModelCollection(PDO $db, $sort=null) {
		$filter=array(PmfInvhisModel::FIELD_JOBID=>$this->getId());
		return PmfInvhisModel::findByFilter($db, $filter, true, $sort);
	}

	/**
	 * Fetch PmfJobhisModel's which this PmfJobModel references.
	 * `pmf_job`.`id` -> `pmf_jobhis`.`jobid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function fetchPmfJobhisModelCollection(PDO $db, $sort=null) {
		$filter=array(PmfJobhisModel::FIELD_JOBID=>$this->getId());
		return PmfJobhisModel::findByFilter($db, $filter, true, $sort);
	}

	/**
	 * Fetch PmfOutinvModel's which this PmfJobModel references.
	 * `pmf_job`.`id` -> `pmf_outinv`.`jobid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function fetchPmfOutinvModelCollection(PDO $db, $sort=null) {
		$filter=array(PmfOutinvModel::FIELD_JOBID=>$this->getId());
		return PmfOutinvModel::findByFilter($db, $filter, true, $sort);
	}

	/**
	 * Fetch PmfProcessModel which references this PmfJobModel. Will return null in case reference is invalid.
	 * `pmf_job`.`procid` -> `pmf_process`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch PmfProcresultModel which references this PmfJobModel. Will return null in case reference is invalid.
	 * `pmf_job`.`resultid` -> `pmf_procresult`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch PmfProcExtrowModel which references this PmfJobModel. Will return null in case reference is invalid.
	 * `pmf_job`.`extrowid` -> `pmf_proc_extrow`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch UsersModel which references this PmfJobModel. Will return null in case reference is invalid.
	 * `pmf_job`.`userid` -> `users`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return UsersModel
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'PmfJobModel');
	}

	/**
	 * get single PmfJobModel instance from a DOMElement
	 *
	...
	/**
	 * get all instances of PmfJobModel from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('PmfJobModel') as $node) {
