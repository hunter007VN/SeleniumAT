 ...
 * @package entity
 */
class PmfInvhisModel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='PmfInvhisModel';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='pmf_invhis';
	const SQL_INSERT='INSERT INTO `pmf_invhis` (`id`,`itemid`,`itemmasterid`,`ssn`,`locid`,`partnerid`,`qty`,`invaction`,`dtm`,`usrid`,`refid`,`jobid`,`caseid`,`bounce`,`coo`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `pmf_invhis` (`itemid`,`itemmasterid`,`ssn`,`locid`,`partnerid`,`qty`,`invaction`,`dtm`,`usrid`,`refid`,`jobid`,`caseid`,`bounce`,`coo`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
	const SQL_UPDATE='UPDATE `pmf_invhis` SET `id`=?,`itemid`=?,`itemmasterid`=?,`ssn`=?,`locid`=?,`partnerid`=?,`qty`=?,`invaction`=?,`dtm`=?,`usrid`=?,`refid`=?,`jobid`=?,`caseid`=?,`bounce`=?,`coo`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `pmf_invhis` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `pmf_invhis` WHERE `id`=?';
	const FIELD_ID=649935218;
	const FIELD_ITEMID=-1429194683;
	const FIELD_ITEMMASTERID=-1183462745;
	const FIELD_SSN=-1326834537;
	const FIELD_LOCID=510705828;
	const FIELD_PARTNERID=-791123028;
	const FIELD_QTY=-1326836417;
	const FIELD_INVACTION=-1140772560;
	const FIELD_DTM=-1326848922;
	const FIELD_USRID=519151096;
	const FIELD_REFID=515951927;
	const FIELD_JOBID=508857825;
	const FIELD_CASEID=-1618107102;
	const FIELD_BOUNCE=-1633738913;
	const FIELD_COO=-1326850036;
	...
	private static $PROPERTY_TYPES=array(
		...
		self::FIELD_BOUNCE=>Db2PhpEntity::PHP_TYPE_BOOL,
	...
	private static $FIELD_TYPES=array(
		...
		self::FIELD_BOUNCE=>array(Db2PhpEntity::JDBC_TYPE_BIT,0,0,true),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of PmfInvhisModel instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param PmfInvhisModel $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return PmfInvhisModel[]
	 */
	public static function findByExample(PDO $db,PmfInvhisModel $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of PmfInvhisModel instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of PmfInvhisModel instances
	 *
	...
	/**
	 * returns the result as an array of PmfInvhisModel instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return PmfInvhisModel[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of PmfInvhisModel instances.
	 *
	...
	/**
	 * Fetch PmfInpinvModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`itemid` -> `pmf_inpinv`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch CasepartModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`caseid` -> `casepart`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch PmfInvactionModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`invaction` -> `pmf_invaction`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch ItemmasterModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`itemmasterid` -> `itemmaster`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch PmfJobModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`jobid` -> `pmf_job`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return PmfJobModel
	...
	/**
	 * Fetch LocationModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`locid` -> `location`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch OrderdetailModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`refid` -> `orderdetail`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch PartnerModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`partnerid` -> `partner`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return PartnerModel
	...
	/**
	 * Fetch UsersModel which references this PmfInvhisModel. Will return null in case reference is invalid.
	 * `pmf_invhis`.`usrid` -> `users`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return UsersModel
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'PmfInvhisModel');
	}

	/**
	 * get single PmfInvhisModel instance from a DOMElement
	 *
	...
	/**
	 * get all instances of PmfInvhisModel from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('PmfInvhisModel') as $node) {
