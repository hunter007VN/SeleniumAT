 ...
 * @package entity
 */
class PmfOutinvModel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='PmfOutinvModel';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='pmf_outinv';
	const SQL_INSERT='INSERT INTO `pmf_outinv` (`id`,`itemid`,`itemmasterid`,`ssn`,`locid`,`partnerid`,`qty`,`invaction`,`dtm`,`usrid`,`refid`,`jobid`,`caseid`,`bounce`,`palletid`,`coo`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `pmf_outinv` (`itemid`,`itemmasterid`,`ssn`,`locid`,`partnerid`,`qty`,`invaction`,`dtm`,`usrid`,`refid`,`jobid`,`caseid`,`bounce`,`palletid`,`coo`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
	const SQL_UPDATE='UPDATE `pmf_outinv` SET `id`=?,`itemid`=?,`itemmasterid`=?,`ssn`=?,`locid`=?,`partnerid`=?,`qty`=?,`invaction`=?,`dtm`=?,`usrid`=?,`refid`=?,`jobid`=?,`caseid`=?,`bounce`=?,`palletid`=?,`coo`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `pmf_outinv` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `pmf_outinv` WHERE `id`=?';
	const FIELD_ID=263209552;
	const FIELD_ITEMID=1597481507;
	const FIELD_ITEMMASTERID=-1835936251;
	const FIELD_SSN=-430428295;
	const FIELD_LOCID=-1331322106;
	const FIELD_PARTNERID=-1624158962;
	const FIELD_QTY=-430430175;
	const FIELD_INVACTION=-1973808494;
	const FIELD_DTM=-430442680;
	const FIELD_USRID=-1322876838;
	const FIELD_REFID=-1326076007;
	const FIELD_JOBID=-1333170109;
	const FIELD_CASEID=1408569088;
	const FIELD_BOUNCE=1392937277;
	const FIELD_PALLETID=1707853360;
	const FIELD_COO=-430443794;
	 ...
	 *
	 * type:SMALLINT,size:5,default:0,nullable
	 *
	 * @param mixed $bounce
	 * @return PmfOutinvModel
	 */
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of PmfOutinvModel instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param PmfOutinvModel $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return PmfOutinvModel[]
	 */
	public static function findByExample(PDO $db,PmfOutinvModel $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of PmfOutinvModel instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of PmfOutinvModel instances
	 *
	...
	/**
	 * returns the result as an array of PmfOutinvModel instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return PmfOutinvModel[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of PmfOutinvModel instances.
	 *
	...
	/**
	 * Fetch PmfInpinvModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`itemid` -> `pmf_inpinv`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch CasepartModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`caseid` -> `casepart`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch PmfInvactionModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`invaction` -> `pmf_invaction`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch ItemmasterModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`itemmasterid` -> `itemmaster`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch PmfJobModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`jobid` -> `pmf_job`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return PmfJobModel
	...
	/**
	 * Fetch LocationModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`locid` -> `location`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch OrderdetailModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`refid` -> `orderdetail`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	/**
	 * Fetch PartnerModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`partnerid` -> `partner`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return PartnerModel
	...
	/**
	 * Fetch UsersModel which references this PmfOutinvModel. Will return null in case reference is invalid.
	 * `pmf_outinv`.`usrid` -> `users`.`id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return UsersModel
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'PmfOutinvModel');
	}

	/**
	 * get single PmfOutinvModel instance from a DOMElement
	 *
	...
	/**
	 * get all instances of PmfOutinvModel from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('PmfOutinvModel') as $node) {
